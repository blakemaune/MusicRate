...
urlpatterns = [
    ...
    path('search/album/', views.album_search, name='album_search'), # Search for an album
    path('search/profile/', views.profile_search, name='profile_search'), # Search for a profile
